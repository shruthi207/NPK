...
public class phosphorous extends AppCompatActivity {
    TextView results;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phosphorous);
        requestQueue = Volley.newRequestQueue(this);
        results = (TextView) findViewById(R.id.textphosres);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i=0; i<feeds.length();i++) {
                                ...
                                String phos = jo.getString("field3");
                                results.setText(phos);
                            }
